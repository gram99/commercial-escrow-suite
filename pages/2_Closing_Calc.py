...
daily_loan_interest = (new_loan_amount * (daily_interest_rate / 100.0)) / 360.0 # Commercial 360-day standard
total_prepaid_interest = daily_loan_interest * days_of_interest

# Fee Allocation Breakdown Logic
...
if misc_amt > 0 and misc_desc:
    st.info(f"➕ **Miscellaneous Fee Added:** Placed '{misc_desc}' costing `${misc_amt:,.2f}` onto the account ledger assigned to **{misc_payer.split(' ')[0]}**.")
